...
.method public constructor <init>(Lcom/google/android/libraries/maps/GoogleMap;ILandroid/content/Context;)V
    ...
    invoke-direct {v5, p1}, Lcom/google/maps/android/collections/MarkerManager;-><init>(Lcom/google/android/libraries/maps/GoogleMap;)V

    new-instance v6, Lcom/google/maps/android/collections/PolygonManager;

    invoke-direct {v6, p1}, Lcom/google/maps/android/collections/PolygonManager;-><init>(Lcom/google/android/libraries/maps/GoogleMap;)V

    new-instance v7, Lcom/google/maps/android/collections/PolylineManager;

    invoke-direct {v7, p1}, Lcom/google/maps/android/collections/PolylineManager;-><init>(Lcom/google/android/libraries/maps/GoogleMap;)V

    new-instance v8, Lcom/google/maps/android/collections/GroundOverlayManager;

    invoke-direct {v8, p1}, Lcom/google/maps/android/collections/GroundOverlayManager;-><init>(Lcom/google/android/libraries/maps/GoogleMap;)V
...
.method public constructor <init>(Lcom/google/android/libraries/maps/GoogleMap;Ljava/io/InputStream;Landroid/content/Context;)V
    .registers 13
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/xmlpull/v1/XmlPullParserException;,
    ...
    invoke-direct {v4, p1}, Lcom/google/maps/android/collections/MarkerManager;-><init>(Lcom/google/android/libraries/maps/GoogleMap;)V

    new-instance v5, Lcom/google/maps/android/collections/PolygonManager;

    invoke-direct {v5, p1}, Lcom/google/maps/android/collections/PolygonManager;-><init>(Lcom/google/android/libraries/maps/GoogleMap;)V

    new-instance v6, Lcom/google/maps/android/collections/PolylineManager;

    invoke-direct {v6, p1}, Lcom/google/maps/android/collections/PolylineManager;-><init>(Lcom/google/android/libraries/maps/GoogleMap;)V

    new-instance v7, Lcom/google/maps/android/collections/GroundOverlayManager;

    invoke-direct {v7, p1}, Lcom/google/maps/android/collections/GroundOverlayManager;-><init>(Lcom/google/android/libraries/maps/GoogleMap;)V
...
.method public constructor <init>(Lcom/google/android/libraries/maps/GoogleMap;Ljava/io/InputStream;Landroid/content/Context;Lcom/google/maps/android/collections/MarkerManager;Lcom/google/maps/android/collections/PolygonManager;Lcom/google/maps/android/collections/PolylineManager;Lcom/google/maps/android/collections/GroundOverlayManager;Lcom/google/maps/android/data/Renderer$ImagesCache;)V
    ...
    :try_end_cd
    .catchall {:try_start_27 .. :try_end_cd} :catchall_dd
